...
class PricingModel():
    ...
    def __init__(self, input_dim, output_dim, neurons, activations, loss_fun, optimiser, learning_rate, epoch, batch_size, calibrate_probabilities=False):
        ...
        # =============================================================
        self.base_classifier = BaseClassifier(input_dim, output_dim, neurons, activations, loss_fun, optimiser, learning_rate, epoch, batch_size)
    ...
    def predict_premium(self, X_raw):
        ...
        try:
            ...
            pass
        premium = self.predict_claim_probability(X_raw) * self.y_mean * 0.7
        return premium
